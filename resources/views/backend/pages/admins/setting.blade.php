                    ...
                    <div class="body">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade in active" id="profile_with_icon_title">
                                <form action="{{ route('admin.profile.update')}}" method="POST" action="" class="form-horizontal" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="row clearfix">
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="change_password_with_icon_title">
                                <form action="{{ route('admin.profile.update')}}" method="POST" action="" class="form-horizontal">
                                    @csrf
                                    @method('PUT')
                                    <div class="row clearfix">
                                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
