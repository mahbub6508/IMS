    ...
    <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h2 class="text-themecolor">Admin Dashboard </h2>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex no-block align-items-center m-t-20 m-b-20">
                                ...
                                <div class="ml-auto">
                                    <h2 class="text-success"><i class="ti-arrow-up"></i> <span class="counter">{{ $total_roles }}</span></h2>
                                </div>
                            </div></a>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex no-block align-items-center m-t-20 m-b-20">
                                ...
                                <div class="ml-auto">
                                    <h2 class="text-purple"><i class="ti-arrow-up"></i> <span class="counter">{{ $total_admins}}</span></h2>
                                </div>
                            </div></a>
                        </div>
                        <div id="sparkline8" class="sparkchart"></div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex no-block align-items-center m-t-20 m-b-20">
                                ...
                                <div class="ml-auto">
                                    <h2 class="text-info"><i class="ti-arrow-up"></i> <span class="counter">{{ $total_category }}</span></h2>
                                </div>
                            </div></a>
                        </div>
                        <div id="sparkline8" class="sparkchart"></div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex no-block align-items-center m-t-20 m-b-20">
                                ...
                                <div class="ml-auto">
                                    <h2 class="text-danger"><i class="ti-arrow-down"></i> <span class="counter">{{ $total_permissions}}</span></h2>
                                </div>
                            </div>
                        </div>
                        <div id="sparkline8" class="sparkchart"></div>
